    ...
    <section className="py-24 bg-[var(--black)] text-white">
      <div className="w-full mx-auto px-8">
        <div className="text-center mb-16">
          <h2 className="font-bebas text-5xl mb-4">Our Engineering <span className="text-[var(--primary)]">Methodology</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <motion.div 
              ...
              className="relative p-8 border border-white/10 bg-white/5 rounded-sm overflow-hidden group"
            >
              ...
              <h3 className="font-bebas text-2xl mb-3 tracking-wide">{step.title}</h3>
