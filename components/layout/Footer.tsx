...
export default function Footer() {
  ...
  const mobileSections = [
    ...
    },
    {
      ...
      title: 'Products',
      links: [
        { label: 'LT Distribution Panels', href: '/products' },
        { label: 'HT Panels', href: '/products' },
        { label: 'MCC / PCC Panels', href: '/products' },
        { label: 'PLC Control Systems', href: '/products' },
      ],
    },
  ]
  ...
  return (
    <footer className="bg-[#111827] border-t-2 border-[var(--primary)] pt-16 md:pt-20">
      ...
      <div className="hidden md:grid site-container grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-8 pb-16">
        {/* Brand */}
