      ...
      <div className="w-full mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-white p-12 rounded-sm shadow-sm border-l-4 border-[var(--primary)]"
          >
            <div className="w-16 h-16 bg-[var(--primary-soft)] rounded-full flex items-center justify-center mb-6 text-[var(--primary)]">
              <Target size={32} />
            </div>
            <h3 className="font-bebas text-4xl text-[var(--accent)] mb-4">Our Mission</h3>
            <p className="font-inter text-lg text-[var(--gray)] leading-relaxed">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-white p-12 rounded-sm shadow-sm border-l-4 border-[var(--accent)]"
          >
            <div className="w-16 h-16 bg-[var(--accent-soft)] rounded-full flex items-center justify-center mb-6 text-[var(--accent)]">
              <Eye size={32} />
            </div>
            <h3 className="font-bebas text-4xl text-[var(--accent)] mb-4">Our Vision</h3>
            <p className="font-inter text-lg text-[var(--gray)] leading-relaxed">
