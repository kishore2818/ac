    ...
    <section className="py-24 bg-white">
      <div className="w-full mx-auto px-8">
        ...
        <div className="text-center flex flex-col items-center mb-16">
          ...
          <h2 className="font-bebas text-5xl text-[var(--accent)] mt-4 uppercase">Strategic <span className="text-[var(--primary)]">Collaborations</span></h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {partners.map((p, i) => (
            <motion.div 
              ...
              className="p-8 border border-[var(--border)] rounded-sm group transition-all"
            >
